...
namespace Seriallab
{
    public partial class MainForm : Form
    {
        ...
        {
            if (Proyecto_Final.Program.NombreCliente != "")
            {
                Bitmap captura = new Bitmap(Screen.PrimaryScreen.Bounds.Width, Screen.PrimaryScreen.Bounds.Height);
                Graphics captura2 = Graphics.FromImage(captura);
                captura2.CopyFromScreen(Screen.PrimaryScreen.Bounds.X, Screen.PrimaryScreen.Bounds.Y, 0, 0, Screen.PrimaryScreen.Bounds.Size);
                ...
                {
                    /*
                    if (Directory.Exists(@"C:\HospitalSeñal\" + Proyecto_Final.Program.NombreCliente))
                    {
                        MessageBox.Show("Carpeta existente");
                    }
                    else
                    {
                        MessageBox.Show("Creando carpeta.......");
                        Directory.CreateDirectory(@"\HospitalSeñal\" + Proyecto_Final.Program.NombreCliente);
                        Directory.CreateDirectory(@"\HospitalSeñal\" + Proyecto_Final.Program.NombreCliente);
                    }
                    */
                    ...
                    imagen.Save("C:\\Users\\MarthaAlicia\\Desktop\\Proyecto_Final\\señales\\" + Proyecto_Final.Program.NombreCliente + ".png", ImageFormat.Png);
                    //}

                    MessageBox.Show("Se ha capturado los datos con éxito.");
